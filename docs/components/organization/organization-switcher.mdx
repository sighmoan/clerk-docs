...
In addition, you also can add custom actions and links to the `<OrganizationSwitcher />` menu. For more information, refer to the [Custom Pages](/docs/components/customization/organization-switcher) documentation.
