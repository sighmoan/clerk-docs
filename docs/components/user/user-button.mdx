...
In addition, you also can add custom actions and links to the `<UserButton />` menu. For more information, refer to the [Custom Menu Items documentation](/docs/components/customization/user-button).
